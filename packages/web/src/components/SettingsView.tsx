        ...
        <div className="max-w-5xl mx-auto flex gap-8 items-start">
          ...
          <div className="flex-1 min-w-0 space-y-6">
            ...
            <Card className="overflow-hidden">
              <div className="px-6 py-4 border-b border-border flex items-center gap-2 bg-surface-secondary rounded-b-2xl">
            ...
            <Card className="overflow-hidden">
              <div className="px-6 py-4 border-b border-border flex items-center justify-between bg-surface-secondary rounded-b-2xl">
